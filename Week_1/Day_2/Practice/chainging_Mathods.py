...
first_user.display_info('Alex', 'Morro', 'alex@gamil.com',23).spend_points(50)
second_user.display_info('Martha', 'Robbert', 'martha@gamil.com',30).spend_points(80)
# enroll have deffrint return(!=self ) we can not empliment it on chaining mathods 
second_user.enroll()
